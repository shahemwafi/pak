    ...
    <footer className="bg-gray-900 text-white">
      <div className="container-custom py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4">Pak Lahore Property</h3>
            <p className="text-gray-400">
              Your trusted partner in real estate. We help you find your dream property in
              Bahria Town and other prime locations in Lahore.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/properties" className="text-gray-300 hover:text-primary transition-colors duration-300">
                  Properties
                </Link>
              </li>
              <li>
